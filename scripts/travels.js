...
// trips.push({
//     name: 'Blue Mountain Snowboarding',
//     startDate: '2015-01-30',
//     endDate: '2015-02-01',
//     pointsOfInterest: [
//         {
//             name: 'Blue Mountain Ski Resort',
//             url: 'http://en.wikipedia.org/wiki/Blue_Mountain_%28ski_resort%29'
//         }
//     ],
//     locations: [
//         {
...
//         }
//     ],
//     photosetId: '72157650606819925'
// });

trips.push({
    name: 'Niagara Falls Getaway',
    startDate: '2015-05-01',
    endDate: '2015-05-02',
    pointsOfInterest: [
        {
            name: 'Niagara Falls',
            url: 'http://en.wikipedia.org/wiki/Niagara_Falls,_Ontario'
        },
        {
            name: 'Wyndham Garden Hotel',
            url: 'http://www.wyndham.com/hotels/ontario/niagara-falls/wyndham-garden-niagara-falls-fallsview/hotel-overview'
        },
        {
            name: 'CopaCabana Brazilian Steakhouse',
            url: 'http://www.thecopa.ca/'
        },
        {
            name: 'Fallsview Casino',
            url: 'http://www.fallsviewcasinoresort.com/'
        },
        {
            name: 'Chocolate FX Factory',
            url: 'http://www.chocolatefx.ca/'
        },
        {
            name: 'Pellar Estates Winery',
    ...
    photosetId: '72157652327123526'
});

trips.push({
    name: 'Mount Nemo Climbing',
    startDate: '2015-05-03',
    endDate: '2015-05-03',
    pointsOfInterest: [
        {
            name: 'Mount Nemo Conservation Area',
            url: 'http://www.conservationhalton.ca/mount-nemo'
        }
    ],
    locations: [
        {
